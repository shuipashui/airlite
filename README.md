...
| 预设 | 布局 | 码版本 | 帧率 | 理论峰值 |
| --- | --- | --- | --- | --- |
| 稳定 | 1 个整屏大码 | V14 | 14 | ~6 KB/s |
| 高速（默认） | 左右 2 个整屏大码 | V15 | 18 | ~18 KB/s |
| 激进 | 左右 2 个整屏大码 | V18 | 18 | ~25 KB/s |
| 极限 | 左右 2 个整屏大码 | V20 | 16 | ~27 KB/s |

发送时顶栏和侧栏会收起，码铺满整个窗口。空格暂停，Esc 停止。近、亮、手稳时用「激进 / 极限」才能摸到 20KB/s 以上。
